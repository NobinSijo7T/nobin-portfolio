...
export default function Hero({ skipPreloader = false }) {
    ...
    useGSAP(() => {
        ...
        if (preloaderComplete) {
            ...
            // Hero section fade-out — custom bezier dissolve as SkillSet appears
            // power3.in = very slow at first, then accelerates hard → natural "hold then snap" feel
            gsap.to(container.current.parentElement, {
                opacity: 0,
                ease: 'power3.in',
                scrollTrigger: {
                    trigger: fakeContainer.current,
                    scrub: 1.2,             // slight lag for extra smoothness
                    start: 'top+=50% top',  // hold full opacity for first half of scroll
                    end: 'bottom top',      // fully dissolved when hero exits
                }
            });

            // Container Animation (pin — must come last)
                            ...
                            <svg width="962" height="995" viewBox="0 0 962 995" fill="none"
                                ...
                                <defs>
                                    <linearGradient id="paint0_linear_2321_30777" x1="960.499" y1="992.187"
                                        ...
                                        <stop offset="0.0001" stopColor="#1A1035" stopOpacity="0.9" />
